...
version is 4.3.11.
  ...
  2. Set the prezto installation directory
  ...
  3. Clone the repository:
     ...
     ```console
     git clone --recursive https://github.com/zijung/prezto.git "$ZPREZTODIR"
     ```
  ...
  5. Modify $ZPREZTODIR in .zshrc if you changed it
